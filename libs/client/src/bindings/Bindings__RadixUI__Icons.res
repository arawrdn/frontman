...
module FigmaIcon = {
  ...
  let make = (~className: option<string>=?, ~style: option<{..}>=?) => {
    ...
    <svg
      ...
      <path fill="#FF3737" d="M0 120c0 66.274 53.726 120 120 120h120V0H120C53.726 0 0 53.726 0 120" />
      <path fill="#874FFF" d="M0 360c0 66.274 53.726 120 120 120h120V240H120C53.726 240 0 293.726 0 360" />
    </svg>
  }
}
