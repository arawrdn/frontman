// Vue CLI-enhanced EditFile tool
//
// Wraps the core edit_file tool and checks dev server logs for compilation
// errors 800ms after the edit. This gives webpack's HMR time to process the
...
let execute = async (ctx: Tool.serverExecutionContext, input: input): Tool.toolResult<output> => {
  ...
  | Ok(output) =>
    // Wait 800ms for webpack HMR to process the change
    await sleep(800)
